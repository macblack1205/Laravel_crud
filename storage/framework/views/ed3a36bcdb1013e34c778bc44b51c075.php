        ...
        <div class="left-container">
            ...
            <div class="register-form">
                ...
                <form action="<?php echo e(route('registerUser')); ?>" method="post">  
                    <?php echo csrf_field(); ?>
                    <div class="passfield">
                    <input type="text" placeholder="Name" name="first" value ="<?php echo e(old('first')); ?>"  autocomplete="off" required>
...
unset($__errorArgs, $__bag); ?> </span>
                    <input type="text" placeholder="Last Name" name="last" value ="<?php echo e(old('last')); ?>" autocomplete="off" required>
...
<?php /**PATH /var/www/resources/views/signup.blade.php ENDPATH**/ ?>